                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card className="bg-gradient-to-br from-zinc-900 to-zinc-900/50">
                        <CardContent className="p-4">
                            ...
                            <p className="text-xl md:text-2xl font-bold text-white">
                                {hashrate.toFixed(1)} <span className="text-sm font-normal text-zinc-400">TH/s</span>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-br from-zinc-900 to-zinc-900/50">
                        <CardContent className="p-4">
                            ...
                            <p className="text-xl md:text-2xl font-bold text-white">
                                {earnings.toFixed(5)} <span className="text-sm font-normal text-zinc-400">BTC</span>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-br from-zinc-900 to-zinc-900/50">
                        <CardContent className="p-4">
                            ...
                            <p className="text-xl md:text-2xl font-bold text-white">
                                {efficiency.toFixed(1)} <span className="text-sm font-normal text-zinc-400">J/TH</span>
                            </p>
                        </CardContent>
                    </Card>
                </div>
                        ...
                        <div className="relative h-48 md:h-64 rounded-xl bg-zinc-900/50 overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="relative">
                                    ...
                                    <div className="absolute inset-0 animate-spin" style={{ animationDuration: '8s' }}>
                                        <div className="w-32 h-32 md:w-48 md:h-48 rounded-full border-2 border-dashed border-orange-500/30" />
                                    </div>

                                    {/* Middle ring */}
                                    <div className="absolute inset-4 animate-spin" style={{ animationDuration: '6s', animationDirection: 'reverse' }}>
                                        <div className="w-24 h-24 md:w-40 md:h-40 rounded-full border-2 border-dashed border-yellow-500/30" />
                                    </div>

                                    {/* Inner ring */}
                                    <div className="absolute inset-8 animate-spin" style={{ animationDuration: '4s' }}>
                                        <div className="w-16 h-16 md:w-32 md:h-32 rounded-full border-2 border-dashed border-green-500/30" />
                                    </div>

                                    {/* Center Bitcoin */}
                                    <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-orange-500/20 to-yellow-500/10 flex items-center justify-center">
                                        <div className="animate-pulse">
                                            <Bitcoin className="h-12 w-12 md:h-16 md:w-16 text-orange-500" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="absolute bottom-4 left-4 right-4 flex justify-between text-xs">
                                <div className="bg-zinc-900/80 backdrop-blur-sm rounded-lg px-3 py-2">
                                    ...
                                    <span className="text-white font-mono">834,291</span>
                                </div>
                                <div className="bg-zinc-900/80 backdrop-blur-sm rounded-lg px-3 py-2">
                                    <span className="text-zinc-400">Network Difficulty: </span>
                                    <span className="text-white font-mono">72.01T</span>
                                </div>
                            </div>
                        </div>
                    </CardContent>
                                    ...
                                    <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-zinc-900/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-zinc-400">{pool.workers} active workers</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm font-medium text-white">{pool.hashrate}</p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={`text-sm font-medium ${temperature > 75 ? 'text-orange-500' : 'text-green-500'}`}>
                                            {temperature.toFixed(0)}°C
                                        </span>
                                    </div>
                                    <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
                                        <div
                                            className={`h-full rounded-full transition-all ${temperature > 75 ? 'bg-orange-500' : 'bg-green-500'}`}
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm font-medium text-white">{power.toFixed(0)}W</span>
                                    </div>
                                    <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
                                        <div
                                            className="h-full bg-yellow-500 rounded-full transition-all"
                                            style={{ width: `${(power / 3000) * 100}%` }}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                                    ...
                                    <span className="text-sm font-medium text-green-400">23d 14h 52m</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
